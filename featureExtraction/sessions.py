...
class Session:
    ...
    def __init__(self, filename, actions, usertype):
        ...
        self.mean_click_time = self.sd_click_time = self.max_click_time = self.min_click_time = 0
        self.mean_approach_time = self.sd_approach_time = self.max_approach_time = self.min_approach_time = 0
    ...
    def calculate_features(self):
        ...
        [self.mean_inter_action_time, self.sd_inter_action_time, self.max_inter_action_time, self.min_inter_action_time] \
            = mean_sd_max_min(inter_action_times)

        return map(str, [self.num_actions, self.mean_inter_action_time, self.sd_inter_action_time,
                         self.max_inter_action_time,
                         self.min_inter_action_time, self.mm_mean_v, self.mm_sd_v, self.mm_max_v, self.mm_min_v,
                         ...
                         self.mm_mean_straightness, self.mm_sd_straightness, self.mm_max_straightness,
                         self.mm_min_straightness, self.mm_mean_num_points, self.mm_sd_num_points,
                         self.mm_max_num_points,
                         self.mm_min_num_points, self.mm_mean_num_points, self.mm_sd_num_points, self.mm_max_num_points,
                         self.mm_min_num_points, self.mm_mean_angle_sum, self.mm_sd_angle_sum, self.mm_max_angle_sum,
                         self.mm_min_angle_sum, self.pc_mean_v, self.pc_sd_v, self.pc_max_v, self.pc_min_v,
                         self.pc_mean_a, self.pc_sd_a, self.pc_max_a, self.pc_min_a, self.pc_mean_j, self.pc_sd_j,
                         self.pc_max_j, self.pc_min_j, self.pc_mean_duration, self.pc_sd_duration, self.pc_max_duration,
                         self.pc_min_duration, self.pc_mean_distance, self.pc_sd_distance, self.pc_max_distance,
                         self.pc_min_distance, self.pc_mean_straightness, self.pc_sd_straightness,
                         self.pc_max_straightness,
                         self.pc_min_straightness, self.pc_mean_num_points, self.pc_sd_num_points,
                         self.pc_max_num_points,
                         self.pc_min_num_points, self.pc_mean_angle_sum, self.pc_sd_angle_sum, self.pc_max_angle_sum,
                         self.pc_min_angle_sum, self.mean_click_time, self.sd_click_time, self.max_click_time,
                         self.min_click_time, self.mean_approach_time, self.sd_approach_time, self.max_approach_time,
                         self.min_approach_time, self.dd_mean_v, self.dd_sd_v, self.dd_max_v, self.dd_min_v,
                         self.dd_mean_a,
                         self.dd_sd_a, self.dd_max_a, self.dd_min_a, self.pc_mean_j, self.pc_sd_j, self.pc_max_j,
                         self.pc_min_j, self.dd_mean_duration, self.dd_sd_duration, self.dd_max_duration,
                         self.dd_min_duration,
                         ...
                         self.dd_mean_straightness, self.dd_sd_straightness, self.dd_max_straightness,
                         self.dd_min_straightness, self.dd_mean_num_points, self.dd_sd_num_points,
                         self.dd_max_num_points,
                         self.dd_min_num_points, self.dd_mean_angle_sum, self.dd_sd_angle_sum, self.dd_max_angle_sum,
                         self.dd_min_angle_sum])
    ...
    def process_point_click_actions(self, actions):
        ...
        [self.mean_click_time, self.sd_click_time, self.max_click_time, self.min_click_time] \
            = mean_sd_max_min(click_times)

        [self.mean_approach_time, self.sd_approach_time, self.max_approach_time, self.min_approach_time] \
